...
public class HidListener_hid4java implements HidServicesListener {
    /*
     ...
     */
    private static final Logger logger = LoggerFactory.getLogger(HidListener_hid4java.class);
...
//        HidListener_hid4java barcodeScannerHidListener1 = new HidListener_hid4java();
